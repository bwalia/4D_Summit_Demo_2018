...
position: absolute; 
	...
	margin: 0;
">
<img src="Z:/Dropbox/4D Databases/4Dv15_Dev/TenthmatrixCRMv15/TENTHMATRIX_CRM_DATA/php_components/MPDF53/examples/tenthmatrix-logo.png" width="190" /><br><h4>Tenthmatrix Information Systems Ltd.</h4>The Coach House, 77A Marlowes, Hemel Hempstead<br />Herts, HP1 1LF<br />Tel: 0207 118 7889<br />Email: billing@tenthmatrix.co.uk</div>
...
<td style="text-align: center;border-bottom: 1px solid #333333;">0044-000813</td>
</tr>
<tr>
...
<td style="text-align: center;border-bottom: 1px solid #333333;">13/10/2014</td>
</tr>
<tr>
...
<td align="center">1</td>
<td>Security SSL Certificate Installation setup and testing on all browsers.</td>
...
<td align="center">1</td>
<td>1 year digital wildcard SSL certificate for netterimages.com domain. Staging server.</td>
...
<p>Date: 02/02/2016, Time: 23:28:21</p>
<p align="right">E&OE</p>
</body>';

//==============================================================//==============================================================//==============================================================include("Z:/Dropbox/4D Databases/4Dv15_Dev/TenthmatrixCRMv15/TENTHMATRIX_CRM_DATA/php_components/MPDF53/mpdf.php");$mpdf=new mPDF('utf-8','A4','','',15,14,10,20,10,10); $mpdf->SetWatermarkText($watermarkTxt,0.05);$mpdf->watermark_font = 'DejaVuSansCondensed';$mpdf->showWatermarkText = true;$mpdf->SetDisplayMode('fullpage');$mpdf->WriteHTML($html . $termsHTML);	// Separate Paragraphs  defined by font$mpdf->Output('C:/Users/tenthmatrix/Desktop/TenthmatrixCRM/Orders/Order-44-813.pdf','F');exit;//==============================================================//==============================================================//==============================================================
